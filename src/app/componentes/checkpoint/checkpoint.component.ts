    ...
    switch (this.seleccionado){
      case 'usuarios': {
        if (args.commandColumn?.type == 'Save'){
          ...
          let content = "<p>idUsuario: " + usuario.idUsuario + "</p><p>Nombre: " + usuario.nombre + "</p><p>Apellidos: " + usuario.apellido + "</p><p>Rol: " + usuario.rol +"</p><p>Correo: " + usuario.correo + "</p><p>idMunicipio: " + usuario.idMunicipio;
